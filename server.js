...
// Handle POST request to /webhook
app.post('/webhook', (req, res) => {
  console.log('Received Webhook:', req.body); // Log the incoming request

  // Process the data and perform actions (like auto-approve the comment)
